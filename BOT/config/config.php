            ...
            <div style="margin-top: 30px; padding: 20px; background: #f5f5f5; border-radius: 8px;">
              ...
              <div style="display: flex; justify-content: center; align-items: center; min-height: 100px;">
                <button type="button" id="phsbot-launcher-preview" class="phsbot-launcher-preview"
                  ...
                  <svg class="phsbot-launcher-icon-preview" viewBox="0 0 300 300" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid meet"
                    ...
                    <g transform="translate(0,300) scale(0.1,-0.1)" fill="currentColor" stroke="none">
                      ...
                      <path d="M1545 2313 c-153 -80 -155 -286 -3 -364 127 -65 287 35 288 179 0 116 -86 202 -202 202 -29 -1 -66 -8 -83 -17z m167 -39 c59 -31 94 -109 78 -178 -18 -80 -78 -128 -160 -128 -93 0 -162 69 -162 162 0 128 128 203 244 144z"/>
                      <path d="M2094 1584 c-105 -51 -39 -210 72 -174 81 27 84 151 3 179 -40 14 -37 14 -75 -5z m78 -51 c22 -20 23 -41 1 -65 -23 -26 -59 -23 -79 7 -15 23 -15 27 0 50 19 29 51 32 78 8z"/>
                      <path d="M2485 1591 c-81 -34 -79 -151 4 -182 31 -12 86 6 106 34 18 25 20 80 4 109 -6 11 -26 26 -44 34 -39 16 -42 16 -70 5z m70 -57 c25 -25 15 -67 -18 -78 -34 -12 -61 1 -65 32 -8 52 46 82 83 46z"/>
                    </g>
                  </svg>
